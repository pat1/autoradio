...
class Enclosure(models.Model):
    ...
    mime = models.CharField('Format', max_length=255, choices=MIME_CHOICES, default='audio/ogg', blank=True)
    ...
    frame = models.CharField('Frame rate', max_length=5, blank=True, help_text='Measured in frames per second (fps), often 29.97.',default='29.97',choices=FRAME_CHOICES)
    bitrate = models.CharField('Bit rate', max_length=5, blank=True, help_text='Measured in kilobits per second (kbps), often 128 or 192.',default="120",choices=BITRATE_CHOICES)
    sample = models.CharField('Sample rate', max_length=5, blank=True, help_text='Measured in kilohertz (kHz), often 44.1.',default="44.1",choices=SAMPLE_CHOICHES)
    channel = models.CharField(max_length=5, blank=True, help_text='Number of channels; 2 for stereo, 1 for mono.',default='stereo',choices=CHANNEL_CHOICES)
